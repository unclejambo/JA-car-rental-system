...
const ManageCarsHeader = ({ activeTab = 'CARS', onTabChange }) => {
  const tabs = ['CARS', 'MAINTENANCE'];
      ...
      {tabs.map((tab) => (
        <Button
          ...
          sx={{
            ...
            boxShadow: 0,
            borderRadius: 0,
            borderTopLeftRadius: tab === 'CARS' ? '8px' : 0,
            borderTopRightRadius: tab === 'MAINTENANCE' ? '8px' : 0,
