...
const RegisterTermsAndConditionsModal = ({
  open,
  onClose,
  onAgree,
  ...
  const modalTitle = hidePersonalInfoSection
    ? 'Car Use Terms and Conditions'
          ...
          {!hidePersonalInfoSection && (
            <div>
              ...
              >
                ...
                expressly consent to the collection, use, storage, and
                processing of your personal information by JA Car Rental for
                legitimate business purposes. We are committed to protecting
                your privacy and handling your data responsibly in accordance
                with applicable data privacy laws, including the Data Privacy
              ...
              <ul className="list-disc ml-6 space-y-1">
                ...
                <li>
                  <Typography variant="body2">
                    ...
                    information (number, expiry date, restrictions) and images
                    of valid identification documents
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2">
                ...
                <li>
                  <Typography variant="body2">
                    ...
                    history, payment information, vehicle usage data, and
                    service preferences
                  </Typography>
                </li>
                <li>
              ...
              <ul className="list-disc ml-6 space-y-1">
                <li>
                  <Typography variant="body2">
                    <strong>Service Delivery:</strong> To process and fulfill
                    your vehicle rental bookings, manage reservations, and
                ...
                <li>
                  <Typography variant="body2">
                    ...
                    identity and eligibility to rent vehicles, ensuring
                ...
                <li>
                  <Typography variant="body2">
                    ...
                    vehicles, prevent fraud, investigate incidents, and ensure
                ...
                <li>
                  <Typography variant="body2">
                    ...
                    confirmations, notifications, reminders, updates about your
                    reservations, and respond to your inquiries
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2">
                    <strong>Business Operations:</strong> To maintain accurate
                    records, conduct internal analysis, improve our services,
                    and comply with legal and regulatory obligations
                  </Typography>
                </li>
                <li>
                  <Typography variant="body2">
                    <strong>Marketing and Promotions:</strong> To inform you
                    about special offers, promotions, new services, and updates
              ...
              >
                ...
                stored securely and accessed only by authorized personnel for
              ...
              >
                ...
                accurate and complete information and that you have the
