...
router.post("/bulk-group", verifyToken, requireCustomer, createGroupedBookings); // Customer grouped bulk booking endpoint
...
router.get(
  "/my-booking-groups/list",
  verifyToken,
  requireCustomer,
  getMyBookingGroups
); // Customer sees own grouped bookings
router.post(
...
router.post(
  ...
  requireCustomer,
  cancelExtensionRequest
); // Customer cancels own extension request
