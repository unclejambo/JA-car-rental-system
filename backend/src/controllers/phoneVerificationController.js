...
export const sendPhoneOTP = async (req, res) => {
  try {
    ...
    console.log('📱 Send OTP request:', { phoneNumber, purpose, userId, userType });
    ...
    try {
      ...
      console.log('✅ OTP SMS sent, code generated by Semaphore:', smsResult.code);
    } catch (smsError) {
    ...
    console.log('💾 OTP stored in database:', verification.id, 'Code:', otpCode);
...
export const verifyPhoneOTP = async (req, res) => {
  try {
    ...
    console.log('🔍 Verify OTP request:', { phoneNumber, otp: otp?.substring(0, 2) + '****', userId, userType });
    ...
    if (userId && userType) {
      try {
        ...
        console.log(`✅ Updated ${userType} phone_verified status`);
      } catch (updateError) {
        console.error('⚠️ Error updating user phone_verified status:', updateError);
