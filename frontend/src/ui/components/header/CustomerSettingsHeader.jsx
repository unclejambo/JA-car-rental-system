...
const CustomerSettingsHeader = ({ activeTab = 'INFO', onTabChange }) => {
  const tabs = ['INFO', 'LICENSE'];
      ...
      {tabs.map((tab) => (
        <Button
          ...
          sx={{
            ...
            boxShadow: 0,
            borderRadius: 0,
            borderTopLeftRadius: tab === 'INFO' ? '8px' : 0,
            borderTopRightRadius: tab === 'LICENSE' ? '8px' : 0,
